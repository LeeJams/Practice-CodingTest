...
function solution_best(id_list, report, k) {
...
console.log(solution_best(["muzi", "frodo", "apeach", "neo"], ["muzi frodo", "apeach frodo", "frodo neo", "muzi neo", "apeach muzi"], 2)); //[2, 1, 1, 0]
console.log(solution_best(["con", "ryan"], ["ryan con", "ryan con", "ryan con", "ryan con"], 3)); //[0, 0]